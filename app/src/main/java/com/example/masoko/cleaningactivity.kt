    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       broom=findViewById(R.id.cardperson)
        ...
        broom.setOnClickListener {
            ...
            val nextpage= Intent(this,vacuumactivity::class.java)
        ...
        washing.setOnClickListener {
            ...
            val nextpage= Intent(this,washingactivity::class.java)
            startActivity(nextpage)
        ...
        vacuum.setOnClickListener {
            ...
            val nextpage= Intent(this,broomactivity::class.java)
            startActivity(nextpage)
